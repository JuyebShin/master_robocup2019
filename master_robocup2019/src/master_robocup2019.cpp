    ...
    else
    {
        ...
        case STATE_READY:
            ...
            if(isPlaying)
            {
                ...
                ikMsg.L_yaw = abs(targetYaw - visionInfo.yaw) > 5 ? DEFAULT_YAW - (targetYaw - visionInfo.yaw) : DEFAULT_YAW;
                    ...
                    if(gameInfo.kickoffTeam == ROBIT)
                    {
                        ...
                        else
                        {
                            ikMsg.L_yaw = DEFAULT_YAW + (abs(visionInfo.yaw) < 90 ?
                                                             (abs(visionInfo.yaw) > 5 ? visionInfo.yaw : 0) :
                                                             (abs(visionInfo.yaw) < 175 ? (visionInfo.yaw > 0 ? visionInfo.yaw - 180 : visionInfo.yaw + 180) : 0));
                        }
                    }
                    else
                    {
        ...
        case STATE_PLAYING:
            ...
            case MODE_BALL_STAND:
                ...
                {
                    isSet = true;
                    if(visionInfo.ballD < 110 && visionInfo.ballD > 0 && visionInfo.ballX != 0)//SHOOT  //f2p 250  220
                    {
                    ...
                    else if(visionInfo.ballD > 110 && visionInfo.ballX != 0)
                    {
                        ikMsg.X_length = DEFAULT_X + 50;
                        ikMsg.Y_length = DEFAULT_Y;
                        ikMsg.Z_length = DEFAULT_Z;
                        ...
                        if(visionInfo.ballD < 350 && visionInfo.ballD > 110)
                        {
                ...
                else //TURN
                {
                    ...
                    else if(visionInfo.ballX != 0)
                    {
                        ...
                        if(visionInfo.ballD > 170)
                            ikMsg.X_length = DEFAULT_X + visionInfo.ballD*0.05;
                        else if(visionInfo.ballD < 150)
                            ikMsg.X_length = DEFAULT_X - visionInfo.ballD*0.05;
            ...
            case MODE_BALL_WALK:
                ...
                if(visionInfo.ballD < 150 && visionInfo.ballD > 0 && visionInfo.ballX != 0)//SHOOT  //f2p 250  220
                {
                    ikMsg.flag = false;
                ...
                else
                {
                    ...
                    if(visionInfo.ballD < 350 && visionInfo.ballD > 150)
                    {
                        ikMsg.X_length = DEFAULT_X + visionInfo.ballD*0.065;
                    }
