        ...
        case STATE_PLAYING:
            ...
            case MODE_BALL_STAND:
                ...
                if(!gameInfo.firstHalf) // 0 ~ 180
                {
                    ...
                    {
                        if(visionInfo.ballD < 140 && visionInfo.ballD > 0 && visionInfo.ballX != 0)//SHOOT  //f2p 250  220
                        {
                        ...
                        else if(visionInfo.ballD > 140 && visionInfo.ballX != 0)
                        {
                            ...
                            if(visionInfo.ballD > 350)
                            {
                                ikMsg.X_length = DEFAULT_X + 40;
                                ikMsg.Y_length = DEFAULT_Y;
                                ikMsg.Z_length = DEFAULT_Z;
                                ikMsg.L_yaw = DEFAULT_YAW - 4;
                            }
                    ...
                    else //NEED TO TURN
                    {
                        ...
                        else if(visionInfo.ballX != 0)//LOST BALL
                        {
                            ...
                            if(visionInfo.ballD > 160)
                                ikMsg.X_length = DEFAULT_X + visionInfo.ballD*0.03;
                            else if(visionInfo.ballD < 160)
                                ikMsg.X_length = DEFAULT_X - visionInfo.ballD*0.03;
            ...
            case MODE_BALL_WALK:
                ...
                if(visionInfo.ballD < 120 && visionInfo.ballD > 0 && visionInfo.ballX != 0)//SHOOT  //f2p 250  220
                {
                    ikMsg.flag = false;
                    robocup_case = MODE_KICK;
                }
                else
                {
                    ...
                    if(visionInfo.ballD < 350 && visionInfo.ballD > 120)
                    {
                        ikMsg.X_length = DEFAULT_X + visionInfo.ballD*0.05;
                    }
